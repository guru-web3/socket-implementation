...
import { QuoteParams, QuoteToken, Route } from "@/app/services/api/socket.interface";
...
(set) => ({
    ...
    setIsRefuelEnabled: (isRefuelEnabled: boolean) => set({ isRefuelEnabled: isRefuelEnabled }),
